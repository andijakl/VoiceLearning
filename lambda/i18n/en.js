module.exports = {
    translation: {
        ...
        FALLBACK_WHILE_TRAINING: "You're currently in a training session. Please answer the question.",
        FALLBACK_WHILE_TRAINING_YES_NO: "You can respond with true or false.",
        FALLBACK_WHILE_TRAINING_NUMERIC: "You need to respond with the number of the correct answer, for example: \"The answer is one\".",
        FALLBACK_REPEAT_QUESTION: "I'll now repeat the question.",
